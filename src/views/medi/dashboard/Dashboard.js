...
for (var i = 0; i <= elements; i++) {
  data1.push(random(70, 200));
  data2.push(random(80, 100));
  data3.push(15, 50);
  data4.push(random(30, 100));
 // data5.push(random(10, 100));
}
...
const mainChart = {
  ...
  datasets: [
    ...
    // {
    //   label: 'My Fifith dataseta',
    //   backgroundColor: 'transparent',
    //   borderColor: 'rgb(181, 201, 3)',
    //   pointHoverBackgroundColor: '#fff',
    //   borderWidth: 2,
    //   //borderDash: [8, 5],
    //   data: data5,
          ...
          <Col>
            <Card>
              <CardBody>
                ...
                <div
                  className="chart-wrapper Inh_chartBar"
              ...
              <CardFooter>
                <Row className="text-center">
                  <Col sm={12} md className="mb-sm-2 mb-0">
                    ...
                    <Progress
                      className="progress-xs mt-2 Inh_chartBar1"
                      //color="rgb(230, 119, 100)"
                      value="40"
                    />
                  </Col>
                  <Col sm={12} md className="mb-sm-2 mb-0 d-md-down-none">
                    ...
                    <Progress
                      className="progress-xs mt-2 Inh_chartBar2"
                      //color="info"
                      value="20"
                    />
                  </Col>
                  <Col sm={12} md className="mb-sm-2 mb-0">
                    ...
                    <Progress
                      className="progress-xs mt-2 Inh_chartBar3"
                      //color="warning"
                      value="60"
                    />
                  </Col>
                  <Col sm={12} md className="mb-sm-2 mb-0">
                    ...
                    <Progress
                      className="progress-xs mt-2  Inh_chartBar4"
                      //color="danger"
                      value="80"
                    />
                  </Col>
                  <Col sm={12} md className="mb-sm-2 mb-0 d-md-down-none">
                    ...
                    <Progress
                      className="progress-xs mt-2  Inh_chartBar5"
                      //color="primary"
                      value="40"
                    />
                  </Col>
