...
const IcomInfoItem = ({ icom, onItemClick, onItemChecked}) => {
  // don't pass key
  const { rowNum, ptnrId, ptnrNm, bizrNo, telNo, email, bankCdNm, bnkacnNo, tkcgr, cretDt} = icom;
