...
import IcomInfoSysInfoItem from './IcomInfoSysInfoItem';
import { tokensToFunction } from 'path-to-regexp';

const columns = ['선택','파트너아이디', '파트너명', '연동시스템 IP', '연동시스템 PORT','등록일자'];

const IcomInfoSysInfoList = ({ medicalInstnList, checkedMedicalInstn, onItemClick, onItemEdit, onItemDelete, onItemChecked,  onWrite }) => {
...
export default IcomInfoSysInfoList;
